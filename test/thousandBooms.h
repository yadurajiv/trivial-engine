#ifndef THOUSANDBOOMS_H_INCLUDED
#define THOUSANDBOOMS_H_INCLUDED


using namespace std;

class thousandBooms : public Trivial::Scene {
public:
...
//        myAudioManager = Trivial::AudioManager::Instance();
    ...
    void update() {
       ...
       float ft = myApp->frameTime()/1000;
        ...
        defaultCamera.moveBy(_scrollbgx,_scrollbgy);
...
#endif // THOUSANDBOOMS_H_INCLUDED
